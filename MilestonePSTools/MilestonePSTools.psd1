@{
    ...
    FunctionsToExport      = @('Get-VmsAlarmDefinition','New-VmsAlarmDefinition','Remove-VmsAlarmDefinition','Set-VmsAlarmDefinition','Copy-VmsClientProfile','Export-VmsClientProfile','Get-VmsClientProfile','Get-VmsClientProfileAttributes','Import-VmsClientProfile','New-VmsClientProfile','Remove-VmsClientProfile','Set-VmsClientProfile','Set-VmsClientProfileAttributes','Connect-Vms','Disconnect-Vms','Get-VmsConnectionProfile','Remove-VmsConnectionProfile','Save-VmsConnectionProfile','Test-VmsConnection','Get-VmsCameraMotion','Get-VmsDeviceEvent','Set-VmsCameraMotion','Set-VmsDeviceEvent','Add-VmsFailoverRecorder','Get-VmsFailoverGroup','Get-VmsFailoverRecorder','New-VmsFailoverGroup','Remove-VmsFailoverGroup','Remove-VmsFailoverRecorder','Set-VmsFailoverGroup','Set-VmsFailoverRecorder','Move-VmsHardware','Assert-VmsLicensedFeature','Get-VmsSystemLicense','Test-VmsLicensedFeature','Get-VmsLicenseDetails','Get-VmsLicensedProducts','Get-VmsLicenseInfo','Get-VmsLicenseOverview','Invoke-VmsLicenseActivation','Get-MobileServerInfo','Set-XProtectCertificate','Get-CameraRecordingStats','Get-CurrentDeviceStatus','Get-VideoDeviceStatistics','Get-VmsCameraReport','Get-VmsRestrictedMedia','New-VmsRestrictedMedia','Remove-VmsRestrictedMedia','Set-VmsRestrictedMedia','Start-VmsRestrictedLiveMode','Stop-VmsRestrictedLiveMode','Add-VmsRoleClaim','Add-VmsRoleMember','Copy-VmsRole','Export-VmsRole','Get-VmsRole','Get-VmsRoleClaim','Get-VmsRoleMember','Get-VmsRoleOverallSecurity','Import-VmsRole','New-VmsRole','Remove-VmsRole','Remove-VmsRoleClaim','Remove-VmsRoleMember','Set-VmsRole','Set-VmsRoleOverallSecurity','Export-VmsRule','Get-VmsRule','Import-VmsRule','New-VmsRule','Remove-VmsRule','Set-VmsRule','Add-VmsArchiveStorage','Add-VmsStorage','Get-VmsArchiveStorage','Get-VmsStorage','Remove-VmsArchiveStorage','Remove-VmsStorage','Set-VmsDeviceStorage','ConvertFrom-ConfigurationApiProperties','ConvertFrom-GisPoint','ConvertFrom-Snapshot','ConvertTo-GisPoint','Get-BankTable','Get-ConfigurationItemProperty','Get-StreamProperties','Install-StableFPS','Invoke-ServerConfigurator','Resize-Image','Select-Camera','Select-VideoOSItem','Set-ConfigurationItemProperty','Get-VmsTrustedIssuer','New-VmsTrustedIssuer','Remove-VmsTrustedIssuer','Assert-VmsRequirementsMet','Get-VmsOpenIdConfig','Get-VmsVmoClient','Split-VmsConfigItemPath','Find-VmsVideoOSItem','Get-VmsVideoOSItem','Get-VmsWebhook','New-VmsWebhook','Remove-VmsWebhook','Set-VmsWebhook','Add-VmsDeviceGroupMember','Add-VmsHardware','Add-VmsLoginProviderClaim','Clear-VmsSiteInfo','Clear-VmsView','ConvertFrom-ConfigurationItem','Copy-VmsView','Copy-VmsViewGroup','Export-VmsHardware','Export-VmsLicenseRequest','Export-VmsViewGroup','Find-ConfigurationItem','Find-XProtectDevice','Get-ManagementServerConfig','Get-PlaybackInfo','Get-RecorderConfig','Get-VmsBasicUser','Get-VmsBasicUserClaim','Get-VmsCameraStream','Get-VmsConnectionString','Get-VmsDeviceGroup','Get-VmsDeviceGroupMember','Get-VmsDeviceStatus','Get-VmsHardwareDriver','Get-VmsHardwarePassword','Get-VmsLoginProvider','Get-VmsLoginProviderClaim','Get-VmsRecordingServer','Get-VmsSiteInfo','Get-VmsStorageRetention','Get-VmsToken','Get-VmsView','Get-VmsViewGroup','Get-VmsViewGroupAcl','Import-VmsHardware','Import-VmsLicense','Import-VmsViewGroup','Join-VmsDeviceGroupPath','New-VmsBasicUser','New-VmsDeviceGroup','New-VmsLoginProvider','New-VmsView','New-VmsViewGroup','Remove-VmsBasicUser','Remove-VmsDeviceGroup','Remove-VmsDeviceGroupMember','Remove-VmsHardware','Remove-VmsLoginProvider','Remove-VmsLoginProviderClaim','Remove-VmsView','Remove-VmsViewGroup','Resolve-VmsDeviceGroupPath','Set-VmsBasicUser','Set-VmsCameraStream','Set-VmsConnectionString','Set-VmsDeviceGroup','Set-VmsHardware','Set-VmsHardwareDriver','Set-VmsLicense','Set-VmsLoginProvider','Set-VmsLoginProviderClaim','Set-VmsRecordingServer','Set-VmsSiteInfo','Set-VmsView','Set-VmsViewGroup','Set-VmsViewGroupAcl','Split-VmsDeviceGroupPath','Start-VmsHardwareScan','Wait-VmsTask')
    CmdletsToExport        = @('Add-Bookmark','Add-EvidenceLock','Add-GenericEvent','Add-RegisteredService','Add-Stream','Add-UserDefinedEvent','Add-VmsLprMatchListEntry','Clear-VmsCache','Clear-VmsLprMatchList','Connect-ManagementServer','Copy-EvidenceLock','Disconnect-ManagementServer','Get-AlarmLine','Get-AlarmStatistics','Get-Bookmark','Get-CameraSetting','Get-ConfigurationItem','Get-DeviceAcl','Get-EventLine','Get-EvidenceLock','Get-GenericEvent','Get-GenericEventDataSource','Get-HardwareSetting','Get-IAlarmClient','Get-IConfigurationService','Get-InputSetting','Get-IServerCommandService','Get-ItemState','Get-Kind','Get-LoginSettings','Get-MetadataSetting','Get-MethodInfo','Get-MicrophoneSetting','Get-MipMessageIdList','Get-OutputSetting','Get-OverallSecurity','Get-PlatformItem','Get-RecorderStatusService2','Get-RegisteredService','Get-SequenceData','Get-Snapshot','Get-SpeakerSetting','Get-Stream','Get-Translations','Get-UserDefinedEvent','Get-VideoSource','Get-VmsCamera','Get-VmsDevice','Get-VmsDeviceGeneralSetting','Get-VmsDeviceStreamSetting','Get-VmsHardware','Get-VmsInput','Get-VmsIServiceRegistrationService','Get-VmsLog','Get-VmsLprEvent','Get-VmsLprMatchList','Get-VmsLprMatchListEntry','Get-VmsManagementServer','Get-VmsMetadata','Get-VmsMetadataLiveRecord','Get-VmsMetadataRecord','Get-VmsMicrophone','Get-VmsModuleConfig','Get-VmsOutput','Get-VmsParentItem','Get-VmsSite','Get-VmsSpeaker','Get-WhoIsOnline','Import-VmsLprMatchList','Invoke-Method','New-Alarm','New-AlarmCondition','New-AlarmOrder','New-VmsLprMatchList','Remove-Bookmark','Remove-EvidenceLock','Remove-GenericEvent','Remove-RegisteredService','Remove-Stream','Remove-UserDefinedEvent','Remove-VmsLprMatchList','Remove-VmsLprMatchListEntry','Select-VmsSite','Send-Alarm','Send-GenericEvent','Send-MipMessage','Send-UserDefinedEvent','Set-CameraSetting','Set-ConfigurationItem','Set-DeviceAcl','Set-HardwareSetting','Set-InputSetting','Set-MetadataSetting','Set-MicrophoneSetting','Set-OutputSetting','Set-OverallSecurity','Set-SpeakerSetting','Set-Stream','Set-VmsCamera','Set-VmsDevice','Set-VmsDeviceGeneralSetting','Set-VmsDeviceStreamSetting','Set-VmsInput','Set-VmsLprMatchList','Set-VmsMetadata','Set-VmsMicrophone','Set-VmsModuleConfig','Set-VmsOutput','Set-VmsSpeaker','Start-Export','Test-Playback','Trace-Events','Update-AlarmLine','Update-Bookmark','Update-EvidenceLock','Update-RegisteredService')
    AliasesToExport        = @('Add-DeviceGroup','Add-DeviceGroupMember','Add-Role','Get-AlarmDefinition','Get-Camera','Get-ConnectionString','Get-DeviceGroup','Get-Hardware','Get-HardwareDriver','Get-HardwarePassword','Get-Input','Get-LicenseDetails','Get-LicensedProducts','Get-LicenseInfo','Get-LicenseOverview','Get-Log','Get-ManagementServer','Get-Microphone','Get-Output','Get-RecordingServer','Get-Site','Get-Speaker','Get-Token','Get-Vms','Get-VmsCameraGeneralSetting','Get-VmsCameraStreamSetting','Get-VmsHardwareGeneralSetting','Get-VmsInputGeneralSetting','Get-VmsMetadataGeneralSetting','Get-VmsMetadataStreamSetting','Get-VmsMicrophoneGeneralSetting','Get-VmsMicrophoneStreamSetting','Get-VmsOutputGeneralSetting','Get-VmsRm','Get-VmsSpeakerGeneralSetting','Get-VmsSpeakerStreamSetting','Invoke-LicenseActivation','New-VmsRm','Remove-DeviceGroup','Remove-Hardware','Remove-Role','Remove-VmsRm','Select-Site','Set-HardwarePassword','Set-VmsCameraGeneralSetting','Set-VmsCameraStreamSetting','Set-VmsHardwareGeneralSetting','Set-VmsInputGeneralSetting','Set-VmsMetadataGeneralSetting','Set-VmsMetadataStreamSetting','Set-VmsMicrophoneGeneralSetting','Set-VmsMicrophoneStreamSetting','Set-VmsOutputGeneralSetting','Set-VmsRm','Set-VmsSpeakerGeneralSetting','Set-VmsSpeakerStreamSetting','Start-VmsRm','Stop-VmsRm')
    FileList               = @()
    PrivateData            = @{
        PSData = @{
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDZPZaOz1bokLsx
# qTQvL7mgj99R5joZlNOFP3/GsMS2KKCCE24wggVyMIIDWqADAgECAhB2U/6sdUZI
...
# BgEEAYI3AgEVMC8GCSqGSIb3DQEJBDEiBCA8gXotHAarKLP8ZQPacDWkuEgmiTUQ
# eISi3+ay6YaUkzA4BgorBgEEAYI3AgEMMSowKKACgAChIoAgaHR0cHM6Ly93d3cu
# bWlsZXN0b25lcHN0b29scy5jb20wDQYJKoZIhvcNAQEBBQAEggIAE7TFNBHZa0h9
# valoJq+XChI5TVGnP7Mur7yh15sStWjIKnRNgfQvSfjTxGd7bgRfj5A0MddCYrdi
# bRLP4UnNVMDTRbbDzxk7PBJ01E/i0jhcEiel0p0otV0s3v7/KBPkLkjIdEr05MmM
# sfu3O9B8AKv88FTvozueWcCAoDpM27sShMu2PO7alnOwFxTukkFXmm77/QLSNXcT
