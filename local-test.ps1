...
$isBasic = "y"
try {
    Write-Host "Verifica di connessione utenza 1 : $username1"
    ...
    Write-Host "Verifica di connessione utenza 2 : $username2"
    ...
    Disconnect-ManagementServer
    Write-Host "Verifiche eseguete con successo."
}
catch {
    Write-Host "Errore durante la verifica delle credenziali: $_"
    exit 1
}